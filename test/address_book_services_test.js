...
describe( 'AddressBookServices', function() {
  ...
  describe( 'handleRequestWithId', function() {
    ...
    address_book_service.setModel( addressBook );

    it( 'handles call with id 1 correct.', function() {
      assert.equal( address_book_service.handleRequestWithId( 1 ), '1. 2<br/>' );
    } );

    it( 'handles call with id 2 correct.', function() {
      assert.equal( address_book_service.handleRequestWithId( 2 ), '2. Wes Jackson<br/>' );
    } );

    it( 'handles call with id 3 correct.', function() {
      assert.equal( address_book_service.handleRequestWithId( 3 ), '3. 2862<br/>' );
    } );
